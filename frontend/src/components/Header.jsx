        ...
        <header className="header">
            ...
            <div className="header-middle-right">
                ...
                <div className="options">
                    ...
                    <span className="icon" style={{ cursor: "pointer" }} onClick={handleProfileClick}>
                    ...
                    <span className="icon" style={{ cursor: "pointer" }} onClick={handleFavoriteClick}>
                    ...
                    <span className="icon cart-icon" style={{ cursor: "pointer" }} onClick={handleCartClick}>
