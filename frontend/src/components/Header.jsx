        ...
        <header className="header">
            ...
            <div className="header-middle-right">
                ...
                <div className="options">
                    ...
                    {/* Ссылка на SignInForm или UserProfile, в зависимости от авторизации */}
                    <Link to={isAuthenticated ? "/user-profile" : "/signin"}>
                        {/* Твоя иконка человечка без изменений */}
                    ...
                    {/* Иконка корзины */}
                    <span className="icon cart-icon" style={{ cursor: "pointer" }}>
                        <svg
                            viewBox="0 0 23 20"
                            xmlns="http://www.w3.org/2000/svg"
                        >
