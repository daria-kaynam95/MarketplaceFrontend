            ...
            <aside className="profile-sidebar">
                ...
                <ul className="profile-menu">
                    <li
                        ...
                        onClick={() => { setSelectedTab("profile"); setIsEditing(false); }}
                    >
                    ...
                    <li
                        ...
                        onClick={() => { setSelectedTab("orders"); setIsEditing(false); }}
                    >
                    ...
                    <li
                        ...
                        onClick={() => { setSelectedTab("favorites"); setIsEditing(false); }}
                    >
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
                            <path
                                d="M12 21.35L10.55 20.03C5.4 15.36 2 12.28 2 8.5C2 5.42 
                    ...
                    <li
                        className={selectedTab === "compare" ? "active" : ""}
                        onClick={() => { setSelectedTab("compare"); setIsEditing(false); }}
                    >
